...
import { fetchRedFlags } from '@/lib/api';
import { Flag, ArrowLeft, Loader2, ChevronDown, ChevronUp, ArrowRight, RefreshCw, AlertTriangle } from 'lucide-react';
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1.5">
                  {chain.matches.map(cif => (
                    <button
                      key={cif}
                      onClick={() => router.push(`/search?cif=${cif}`)}
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {forwardChains.map(renderChain)}
                </div>
              </div>

              {/* Reverse chains: Бусад → Спортбет */}
              <div>
                <div className="flex items-center gap-2 mb-3">

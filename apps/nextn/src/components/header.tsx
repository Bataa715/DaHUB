  ...
  return (
    <header className="sticky top-0 left-0 w-full z-50 min-h-[60px] md:min-h-[72px]">
      <div className="relative">
        <div className="mx-3 md:mx-4 mt-3 md:mt-4 grid grid-cols-[1fr_auto_1fr] items-center p-2 px-4 bg-background/80 supports-[backdrop-filter]:bg-background/60 backdrop-blur-xl rounded-2xl border border-border/60 shadow-premium ring-hairline">
                ...
                {mainLinks.map((link) => {
                  ...
                  return (
                    <Link
                      ...
                      href={link.href}
                      className={cn(
                        "relative px-3 py-1.5 rounded-lg text-sm font-semibold tracking-tight transition-colors",
                        isActive
          ...
          <div className="justify-self-center">
            <Link
              href={isAdminPage ? "/admin" : "/"}
              className="group font-bold text-2xl tracking-tighter text-foreground hover:text-primary transition-colors flex items-center gap-2.5"
            >
              <Image
                src="/golomt.jpg"
                alt="Golomt"
                width={32}
                height={32}
                className="rounded-lg ring-1 ring-border/70 shadow-sm transition-transform duration-300 group-hover:scale-105"
              />
              {isAdminPage ? t("navAdminPanel") : appName}
            </Link>
          </div>

...
export const DEPARTMENT_POSITIONS: Record<string, string[]> = {
  ...
  "Зайны аудит чанарын баталгаажуулалтын хэлтэс": ["Хэлтсийн захирал", "Ахлах аудитор", "Аудитор"],
  "Мэдээллийн технологийн аудитын хэлтэс": ["Хэлтсийн захирал","Ахлах аудитор", "Аудитор"],
};

...
import { Eye, EyeOff, Loader2, Check, User as UserIcon } from "lucide-react";
...
export default function SettingsPage() {
  ...
  const TABS: { key: Tab; label: string }[] = [
    { key: "profile", label: t("navProfileSettings") },
    { key: "password", label: t("passwordChangeBtn") },
  ];
  ...
  return (
    <>
      ...
      />
      <div className="mx-auto w-full min-w-0 max-w-[1600px] px-4 sm:px-6 lg:px-8 flex items-start justify-center py-8">
              ...
              {tab === "password" && (
                <form onSubmit={handlePasswordChange} className="space-y-4">
                  ...
                  <button
                    ...
                    className="flex w-full items-center justify-center gap-2 rounded-xl bg-foreground py-2.5 text-sm font-semibold text-background transition-opacity duration-300 hover:opacity-90 disabled:opacity-40"
                  >
                    {isChangingPassword && (

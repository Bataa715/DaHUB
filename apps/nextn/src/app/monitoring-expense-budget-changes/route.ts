...
/**
 * Expense monitoring budget-changes drill-down BFF — `/api` биш тул prod
 ...
 * POST /monitoring/expense-budget-changes руу дамжуулна.
 */
export async function POST(req: NextRequest) {
  ...
  try {
    const upstream = await fetch(
      `${backendUrl}/monitoring/expense-budget-changes`,
      {
        method: "POST",
        headers: {
    ...
    console.error(
      "[monitoring-expense-budget-changes] upstream fetch failed:",

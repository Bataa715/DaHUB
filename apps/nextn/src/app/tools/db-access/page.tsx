              ...
              <div className="space-y-3">
                {!tableFilter && tables.length > 0 && (
                  <button
                    type="button"
                    onClick={toggleAll}
                    className="flex w-full items-center gap-2 rounded-lg border border-dashed border-border px-2.5 py-2 text-xs text-muted-foreground transition-colors hover:border-primary/40 hover:text-foreground"
                  >
                    <CheckBox
                  ...
                  <div className="flex flex-wrap gap-1 pt-2 border-t border-border">
                    {selectedTables.map((full) => (
                      <button
                        ...
                        className="text-[11px] font-mono px-1.5 py-0.5 rounded bg-muted/60 text-muted-foreground hover:text-destructive hover:bg-destructive/10 transition-colors"
                        title="Remove"
                      >
                        {full} ×
                      </button>

...
import {
  ...
  labelSt,
  bodyTxt,
} from "./_word-preview/styles";
import { SummaryPage } from "./_word-preview/summary-page";
        ...
        >
          ...
          >
            ...
            {SECTION_DEFS.map((def) => {
              ...
              const s2kpiData =
                def.id === "s2"
                  ? mergeKpi(sec.s2kpiTable, DEFAULT_S2_KPI)
                  : null;

              const s3kpiData =
                def.id === "s3"
                  ? mergeKpi(sec.s3kpiTable, DEFAULT_S3_KPI)
                  : null;

              const s4kpiData =
                def.id === "s4"
                  ? mergeKpi(sec.s4kpiTable, DEFAULT_S4_KPI)
                  : null;
                    ...
                    <div style={{ paddingLeft: "6pt" }}>
                      ...
                      {sec.content.trim() && (
                        <div style={{ marginBottom: "8pt" }}>
                          ...
                          >
                            Сургалт, хөгжлийн төлөв байдалын дэлгэрэнгүй
                            тайлбар:
                          </div>
                          <div
                            style={{

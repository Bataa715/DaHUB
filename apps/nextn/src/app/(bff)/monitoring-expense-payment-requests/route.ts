...
/**
 * Expense monitoring payment-requests drill-down BFF — `/api` биш тул prod
 ...
 * POST /monitoring/expense-payment-requests руу дамжуулна.
 */
export async function POST(req: NextRequest) {
  ...
  try {
    const upstream = await fetch(
      `${backendUrl}/monitoring/expense-payment-requests`,
      {
        method: "POST",
        headers: {
    ...
    console.error(
      "[monitoring-expense-payment-requests] upstream fetch failed:",

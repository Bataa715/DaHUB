...
/** Returns e.g. "ДАА", "БАХ", "МТАХ" from the dept name */
function deptAbbrev(deptName: string): string {
  const MAP: Record<string, string> = {
    "Дата анализын алба": "ДАА",
    "Дата Анализын Алба": "ДАА",
    "Бизнесийн аудитын хэлтэс": "БАХ",
    "Эрсдэл, комплаенс, санхүүгийн аудитын хэлтэс": "ЭКСАХ",
    "Мэдээллийн технологийн аудитын хэлтэс": "МТАХ",
    "Чанарын баталгаажуулалтын алба": "ЧБА",
    Удирдлага: "ДАГ",
  };
...
function deptGenitive(name: string): string {
  const MAP: Record<string, string> = {
    ...
    "Дата Анализын Алба": "ДАТА АНАЛИЗЫН АЛБАНЫ",
    "Бизнесийн аудитын хэлтэс": "БИЗНЕСИЙН АУДИТЫН ХЭЛТСИЙН",
    "Эрсдэл, комплаенс, санхүүгийн аудитын хэлтэс":
      "ЭРСДЭЛ, КОМПЛАЕНС, САНХҮҮГИЙН АУДИТЫН ХЭЛТСИЙН",
    "Мэдээллийн технологийн аудитын хэлтэс":
      "МЭДЭЭЛЛИЙН ТЕХНОЛОГИЙН АУДИТЫН ХЭЛТСИЙН",
    "Чанарын баталгаажуулалтын алба": "ЧАНАРЫН БАТАЛГААЖУУЛАЛТЫН АЛБАНЫ",
